...
irrdb_client* rrdb_client_factory::get_client(const char* app_name, const char* cluster_name)
{
    return rrdb_client_factory_impl::get_client(app_name, cluster_name);
}
